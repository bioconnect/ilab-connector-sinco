...
namespace sdms_connector
{
    public partial class ServerMng : Form
    {
        ...
        public ServerMng()
        {
            ...
            btnDel.Text = Global.GetMultiLang("E-TXT-DELETE", "삭제");
        ...
        private void MakeDataGridView()
        {
            ...
            dgvSever.Columns["SVR_SEQ"].HeaderText = "순번";
            dgvSever.Columns["SVR_NM"].HeaderText = "서버명";
            dgvSever.Columns["SVR_IP"].HeaderText = "IP:PORT";
            dgvSever.Columns["DEFAULT_YN"].HeaderText = "기본값여부";
        ...
        private void btnDefault_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show(Global.GetMultiLang("E-MSG-SEL_SERVER", "선택한 서버가 기본설정 되었습니다."));
            MakeDataGridView();
