...
namespace clawSoft.clawPDF.SetupHelper.Driver
{
    public class clawPDFInstaller
    {
        ...
        private const string PRINTERNAME = "BASE PDF";
        private const string DRIVERNAME = "BASE PDF Virtual Printer";
        private const string HARDWAREID = "BASE_PDF_Driver";
        ...
        private const string DRIVERMANUFACTURER = "BIOCONNECT";
        ...
        private bool ConfigureclawPDFPort(String commandValue)
        {
            ...
            try
            {
                ...
                portConfiguration.SetValue("Description", "sdmsPDF", RegistryValueKind.String);
