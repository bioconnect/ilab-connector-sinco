        ...
        public bool TryRepairPrinter(IEnumerable<string> printerNames)
        {
            ...
            if (IsRepairRequired())
            {
                ...
                message = _translator.GetFormattedTranslation("Application", "RepairPrinterFailed",
                    "BASE PDF was not able to repair your printers. Please contact your administrator or the support to assist you in with this problem.");
